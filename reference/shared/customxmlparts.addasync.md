...
# <a name="customxmlparts.addasync-method"></a>NodeDeletedEventArgs.oldNode メソッド
...
|**名前**|**型**|**説明**|**サポートのメモ**|
|:-----|:-----|:-----|:-----|
| _xml_|**string**|新しく作成するカスタム XML パーツに追加する XML。必須。||
...
**addAsync** メソッドに渡されるコールバック関数で、**AsyncResult** オブジェクトのプロパティを使用して次の情報を返すことができます。



|**プロパティ**|**使用目的**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|新規に作成された [CustomXmlPart](../../reference/shared/customxmlpart.customxmlpart.md) オブジェクトを返します。|
