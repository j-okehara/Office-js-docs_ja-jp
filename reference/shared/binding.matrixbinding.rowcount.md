...
# <a name="matrixbinding.rowcount-property"></a>MatrixBinding.rowCount プロパティ
マトリックス データ構造内の行数を整数値で取得します。
...
指定された [MatrixBinding](../../reference/shared/binding.matrixbinding.md) オブジェクト内の行数。
