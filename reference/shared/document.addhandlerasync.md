...
| _handler_|**object**|追加するイベント ハンドラー関数で、唯一のパラメーターは [DocumentSelectionChangedEventArgs](../../reference/shared/document.selectionchangedeventargs.md) 型です。必須です。||
