...
# <a name="customxmlnode.getnodevalueasync-method"></a>CustomXmlNode.getNodeValueAsync メソッド
ノードの値を非同期的に取得します。
...
**getNodeValueAsync** メソッドに渡されたコールバック関数では、**AsyncResult** オブジェクトのプロパティを使用して、次の情報を返すことができます。



|**プロパティ**|**使用目的**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|参照されるノードの値を含む **string** にアクセスします。|
