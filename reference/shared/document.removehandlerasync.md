...
# <a name="document.removehandlerasync-method"></a>Document.removeHandlerAsync メソッド
...
|**名前**|**型**|**説明**|**サポートのメモ**|
|:-----|:-----|:-----|:-----|
| _eventType_|[EventType](../../reference/shared/eventtype-enumeration.md)|削除するイベントの型を指定します。必須。||
