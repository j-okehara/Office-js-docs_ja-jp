...
|**名前**|**型**|**説明**|**サポートのメモ**|
|:-----|:-----|:-----|:-----|
| _id_|**string**|バインド オブジェクトの一意の識別名を指定します。必須です。||
...
|**プロパティ**|**使用目的**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|呼び出しの [id](../../reference/shared/binding.md) で指定されている_Binding_ オブジェクトにアクセスします。|
