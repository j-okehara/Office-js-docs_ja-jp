...
# <a name="customxmlprefixmappings.addnamespaceasync-method"></a>CustomXmlPrefixMappings.addNamespaceAsync メソッド
...
|**名前**|**型**|**説明**|**サポートのメモ**|
|:-----|:-----|:-----|:-----|
| _prefix_|**string**|プレフィックスのマッピング リストに追加するプレフィックスを指定します。必須。||
| _ns_|**string**|新しく追加されるプレフィックスに割り当てる名前空間を指定します。必須。||
