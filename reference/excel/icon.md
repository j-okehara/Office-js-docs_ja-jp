# <a name="icon-object-javascript-api-for-excel"></a>Icon オブジェクト (JavaScript API for Excel)
...
| プロパティ     | 型   |説明| 要件セット|
|:---------------|:--------|:----------|:----|
|index|int|指定したセット内のアイコンのインデックスを表します。|[1.2](../requirement-sets/excel-api-requirement-sets.md)|
