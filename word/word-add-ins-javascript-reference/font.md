...
|underline|[UnderlineType](underlinetype.md)|フォントの下線の種類を示す値を取得または設定します。有効な値は次のとおりです。"None"、"Single"、"Word"、"Double"、"Dotted"、"Hidden"、"Thick"、"Dashline"、"Dotline"、"DotDashLine"、"TwoDotDashLine"、"Wave"|
