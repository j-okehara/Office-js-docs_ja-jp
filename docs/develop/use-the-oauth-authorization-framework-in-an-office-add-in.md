...
# Office アドインで OAuth 認証フレームワークを使用する
...
## 手順 2 と 3 - 認証フローを開始して、サインイン ページを表示する
...
## 手順 4、5、6 - ユーザーがサインインして、Web サーバーでトークンを受信する
