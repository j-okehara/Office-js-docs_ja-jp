...
- [無料の試用版](https://msdn.microsoft.com/en-us/library/dn456317.aspx#Anchor_1)を提供します。アドインでサブスクリプションを要求する場合は、一部の機能をサブスクリプションなしでも利用できるようにします。
...
- Office リボンを拡張するアドイン:
  ...
  - アドインの使用スペースを増やす余分なボタンを追加しないでください。
     ...
     >**注**  占有領域が大きすぎるアドインは [Office ストア検証](https://msdn.microsoft.com/en-us/library/jj220035.aspx) を通過しない場合があります。
...
- [アクセシビリティ](../design/accessibility-guidelines.md)を考慮してください。すべてのユーザーにとって操作しやすいアドインにして、画面リーダーなどの支援テクノロジが利用できるようにしてください。
