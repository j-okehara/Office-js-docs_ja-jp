...
この記事では、Excel の JavaScript API を使用して Excel 2016 のアドインをビルドする基本的な方法について説明します。Excel の JavaScript API の詳細については、[リファレンス](excel-add-ins-javascript-api-reference.md)のページを参照してください。
