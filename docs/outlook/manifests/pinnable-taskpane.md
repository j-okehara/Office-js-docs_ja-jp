...
> **注**:ピン留め可能な作業ウィンドウは、現在 Windows 版 Outlook 2016 でのみサポートされています (Current Channel または Office Insider Channel のユーザーはビルド 7668.2000 以降、Deferred Channel のユーザーはビルド 7900.xxxx 以降)。
